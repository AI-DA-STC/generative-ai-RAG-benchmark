...
@click.option('--qa_data_path', type=click.Path(exists=True), default=os.path.join(data_path, 'QA/generated_qa_sentence_1024.parquet'))
@click.option('--corpus_data_path', type=click.Path(exists=True), default=os.path.join(data_path, 'corpus/generated_corpus_sentence_1024.parquet'))
